-- =============================================================================
-- V18 (PostgreSQL): 사이트 도메인, 배너, 팝업, 메인이미지
-- - 배너/팝업/메인이미지는 tb_domain_list.domain_id 를 FK로 참조
-- - 시드 데이터는 개발·로컬 확인용이며, 재실행 시 ON CONFLICT DO NOTHING 으로 중복 방지
-- =============================================================================
...
-- -----------------------------------------------------------------------------
-- 시드: 도메인 + 샘플 배너/팝업/메인이미지 (이미 있으면 스킵)
-- -----------------------------------------------------------------------------
