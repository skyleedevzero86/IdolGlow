...
class WishCommandRepository(
    ...
    fun findByUserIdAndProductId(
        userId: Long,
        productId: Long,
    ): Wish? = wishJpaRepository.findByUserIdAndProductId(userId, productId)

    fun deleteByUserId(userId: Long) = wishJpaRepository.deleteByUserId(userId)

    fun deleteByProductId(productId: Long) = wishJpaRepository.deleteByProductId(productId)
}
