...
class AdminReservationQueryRepository(
    ...
    fun countReservationsByStatus(
        fromDate: LocalDate?,
        toDate: LocalDate?,
    ): Map<ReservationStatus, Long> {
    ...
    fun countPaymentsByStatus(
        fromDate: LocalDate?,
        toDate: LocalDate?,
    ): Map<PaymentStatus, Long> {
        @Suppress("UNCHECKED_CAST")
        val rows =
            createDateRangeQuery(
                """
    ...
    fun findPaymentsByVisitDateRange(
        fromDate: LocalDate,
        toDate: LocalDate,
        max: Int,
    ): List<Payment> =
    ...
    fun findReservationsByVisitDateRange(
        fromDate: LocalDate,
        toDate: LocalDate,
        max: Int,
    ): List<Reservation> =
    ...
    fun findPaymentsByReservationIds(reservationIds: List<Long>): Map<Long, AdminReservationPaymentProjection> {
        ...
        return rows.associate { row ->
            ...
            reservationId to
                AdminReservationPaymentProjection(
    ...
    private fun createDateRangeQuery(
        baseQuery: String,
        fromDate: LocalDate?,
        toDate: LocalDate?,
    ) = entityManager
    ...
    private fun buildDateRangeClause(
        fromDate: LocalDate?,
        toDate: LocalDate?,
    ): String {
        val conditions = mutableListOf<String>()
    ...
    private fun buildNativeVisitDateClause(
        fromDate: LocalDate?,
        toDate: LocalDate?,
    ): String {
        val conditions = mutableListOf<String>()
