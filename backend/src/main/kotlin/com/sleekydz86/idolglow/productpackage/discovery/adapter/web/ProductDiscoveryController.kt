...
@Tag(name = "상품 추천", description = "상품 추천 및 랭킹 조회 API")
@RestController
...
class ProductDiscoveryController(
    ...
    ): ResponseEntity<List<ProductRankingResponse>> = ResponseEntity.ok(productDiscoveryService.findPopularProducts(size.coerceIn(1, 50)))
