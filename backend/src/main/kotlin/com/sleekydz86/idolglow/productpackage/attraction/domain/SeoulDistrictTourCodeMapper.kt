...
object SeoulDistrictTourCodeMapper {
    ...
    private val signguCodeByDistrict: Map<String, Int> =
        mapOf(
            "강남구" to 11680,
            "강동구" to 11740,
            "강북구" to 11305,
    ...
    fun signguCodeOf(districtLabel: String): Int? = signguCodeByDistrict[districtLabel.trim()]

    fun districtOf(signguCode: Int): String? = signguCodeByDistrict.entries.firstOrNull { it.value == signguCode }?.key
