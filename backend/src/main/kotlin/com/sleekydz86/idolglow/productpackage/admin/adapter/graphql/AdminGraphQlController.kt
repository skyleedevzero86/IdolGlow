...
class AdminGraphQlController(
    ...
    @QueryMapping
    fun adminProductSlots(
        @Argument productId: String,
    ): List<AdminReservationSlotGraphQlResponse> =
        adminCatalogService
            .findSlots(productId.toGraphQlIdLong("productId"))
    ...
    @MutationMapping
    fun createOption(
        @Argument @Valid input: CreateOptionRequest,
    ): OptionGraphQlResponse = OptionGraphQlResponse.from(optionCommandService.createOption(input.toCommand()))

    @MutationMapping
    fun createProduct(
        @Argument @Valid input: CreateProductRequest,
    ): ProductCreatedGraphQlResponse =
    ...
    @MutationMapping
    fun deleteAdminReservationSlot(
        @Argument slotId: String,
    ): Boolean {
    ...
    @MutationMapping
    fun deleteAdminOption(
        @Argument optionId: String,
    ): Boolean {
