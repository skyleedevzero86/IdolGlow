...
class AdminOperationsAnalyticsService(
    ...
    ): OperationsAnalyticsSummaryResponse {
    ...
    fun cancellationComparison(
        visitDateFrom: LocalDate,
        visitDateTo: LocalDate,
    ): CancellationComparisonResponse {
    ...
    fun cancelReasonStats(
        canceledAtFrom: LocalDateTime,
        canceledAtTo: LocalDateTime,
    ): List<CancelReasonStatRow> {
    ...
    fun paymentFailuresByHour(
        failedAtFrom: LocalDateTime,
        failedAtTo: LocalDateTime,
    ): List<PaymentFailureHourRow> {
        @Suppress("UNCHECKED_CAST")
        val times =
            entityManager
                .createQuery(
    ...
    fun menuStats(): OperationsMenuStatsResponse {
        val reservationCounts =
            adminReservationQueryRepository.countReservationsByStatus(
                fromDate = null,
                toDate = null,
            )
        val paymentCounts =
            adminReservationQueryRepository.countPaymentsByStatus(
                fromDate = null,
                toDate = null,
            )
    ...
    private fun periodCancellationMetrics(
        from: LocalDate,
        to: LocalDate,
    ): PeriodCancellationMetrics {
