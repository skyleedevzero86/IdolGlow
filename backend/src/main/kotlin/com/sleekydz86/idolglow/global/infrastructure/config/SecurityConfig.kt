...
import com.sleekydz86.idolglow.global.adapter.security.JsonAccessDeniedHandler
import com.sleekydz86.idolglow.global.adapter.security.JsonAuthenticationEntryPoint
import com.sleekydz86.idolglow.global.adapter.security.JwtFilter
import com.sleekydz86.idolglow.global.adapter.security.JwtProvider
import com.sleekydz86.idolglow.user.auth.adapter.oauth.CustomOAuth2UserService
import com.sleekydz86.idolglow.user.auth.adapter.oauth.OAuth2LoginFailureHandler
import com.sleekydz86.idolglow.user.auth.adapter.oauth.OAuth2SuccessHandler
    ...
    fun securityFilterChain(http: HttpSecurity): SecurityFilterChain {
        http
            ...
            .authorizeHttpRequests { auth ->
                ...
                auth.requestMatchers("/ws-mbrd/**").permitAll()
