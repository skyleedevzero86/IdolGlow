...
import com.sleekydz86.idolglow.global.graphql.CreateProductReviewGraphQlInput
import com.sleekydz86.idolglow.global.graphql.CreateReservationGraphQlInput
import com.sleekydz86.idolglow.global.graphql.ReservationCreatedGraphQlResponse
import com.sleekydz86.idolglow.global.graphql.WishToggleGraphQlResponse
...
class MutationGraphQlController(
        ...
        val created =
            reservationCommandService.createReservation(
                CreateReservationCommand(
                    ...
                    reservationSlotId =
                        input.reservationSlotId.toLongOrNull()
                            ?: throw IllegalArgumentException("reservationSlotId는 숫자여야 합니다."),
                    userId = userId,
                    totalPrice =
                        input.totalPrice.toBigDecimalOrNull()
    ...
    fun registerSlotWaitlist(
        ...
        val sid =
            reservationSlotId.toLongOrNull()
                ?: throw IllegalArgumentException("reservationSlotId는 숫자여야 합니다.")
        ...
        val review =
            productReviewCommandService.createReview(
                CreateProductReviewCommand(
                    ...
                    userId = userId,
                    reservationId =
                        input.reservationId.toLongOrNull()
                            ?: throw IllegalArgumentException("reservationId는 숫자여야 합니다."),
                    rating = input.rating,
