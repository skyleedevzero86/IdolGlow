...
class ScheduleRepositoryImpl(
    ...
    override fun save(schedule: Schedule): Schedule = scheduleJpaRepository.save(schedule)

    override fun findByIdAndUserId(
        scheduleId: Long,
        userId: Long,
    ): Schedule? = scheduleQueryRepository.findByIdAndUserId(scheduleId, userId)

    override fun findByUserId(
        userId: Long,
        cursorId: Long?,
        size: Int,
    ): List<Schedule> = scheduleQueryRepository.findByUserId(userId, cursorId, size)
    ...
    override fun delete(schedule: Schedule) = scheduleJpaRepository.delete(schedule)
}
