...
class SpcdeInfoApiClient(
    ...
    fun getHoliDeInfo(
        solYear: String,
        solMonth: String,
    ): List<SpecialDayInfo> = fetch("getHoliDeInfo", solYear, solMonth, "SPCDE_HOLIDE_INFO")

    fun getRestDeInfo(
        solYear: String,
        solMonth: String,
    ): List<SpecialDayInfo> = fetch("getRestDeInfo", solYear, solMonth, "SPCDE_RESTDE_INFO")

    fun getAnniversaryInfo(
        solYear: String,
        solMonth: String,
    ): List<SpecialDayInfo> = fetch("getAnniversaryInfo", solYear, solMonth, "SPCDE_ANNIVERSARY_INFO")
    ...
    private fun fetch(
        ...
        val root =
            runCatching { objectMapper.readTree(body) }.getOrElse {
