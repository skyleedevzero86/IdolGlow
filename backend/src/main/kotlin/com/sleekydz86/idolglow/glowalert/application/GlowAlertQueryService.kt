    ...
    private fun findDatabaseAlerts(
        ...
        val statusItems =
            notificationRepository
                .findVisibleByUserId(userId, now.minusMonths(1))
...
private data class GlowAlertSeed(
    ...
    fun isVisibleAt(now: LocalDateTime): Boolean = !receivedAtDateTime.isBefore(now.minusMonths(1))
...
private fun Notification.categoryId(): String = type.categoryId()
