...
class UserSurveyRepositoryImpl(
    ...
    override fun findByUserId(userId: Long): UserSurvey? = userSurveyJpaRepository.findFirstByUserIdOrderByIdDesc(userId)

    override fun existsByUserId(userId: Long): Boolean = userSurveyJpaRepository.existsByUserId(userId)

    override fun save(userSurvey: UserSurvey): UserSurvey = userSurveyJpaRepository.save(userSurvey)
