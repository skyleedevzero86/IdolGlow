...
class UserOAuthRepositoryImpl(
    ...
    override fun save(userOAuth: UserOAuth): UserOAuth = userOAuthJpaRepository.save(userOAuth)
    ...
    override fun findAllByUserId(userId: Long): List<UserOAuth> = userOAuthJpaRepository.findAllByUserId(userId)

    override fun findByEmail(email: String): UserOAuth? = userOAuthJpaRepository.findByEmail(email)
}
